...
<body>
    ...
    <script>
        ...
        function toggleEntryCollapse(btn) {
            btn.closest('.repeatable-entry').classList.toggle('collapsed');
        }
        ...
        function addExperienceEntry(data) {
            ...
            entry.innerHTML =
                '<div class="entry-header" onclick="toggleEntryCollapse(this.querySelector(\'button\'))">' +
